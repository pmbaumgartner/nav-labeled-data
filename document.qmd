...
```{python}
# | label: data-read
# | fig-cap: "The first five rows of the HappyDB Dataset"
import pandas as pd
...
# | fig-cap: "The distribution of labels"
...
# | fig-cap: "Similarity values of sentence-embedding pairs"
...
```{python}
# | fig-cap: "CleanLab Health Summary - Classes by Label Quality"
display(data_health_summary["classes_by_label_quality"])
```

```{python}
# | fig-cap: "CleanLab Health Summary - Overlapping Classes"

display(data_health_summary["overlapping_classes"])
```

```{python}
# | fig-cap: "Sample of Texts with Possible Label Errors"
